    ...
    (Ft.prototype = {
                ...
                if (
                    ...
                    if (((ot = j(l)), (rt = j(l, t.draggable)), 'function' == typeof c)) {
                        if (c.call(this, e, l, this))
                            return (
                                q({ sortable: n, rootEl: s, name: 'filter', targetEl: l, toEl: o, fromEl: o }),
                                G('filter', n, { evt: e }),
                        ...
                        (c =
                            ...
                            c.split(',').some(function (t) {
                                if ((t = P(s, t.trim(), o, !1)))
                                    return (
                                        q({ sortable: n, rootEl: t, name: 'filter', targetEl: l, fromEl: o, toEl: o }),
                                        G('filter', n, { evt: e }),
                                        !0
                                    );
                            }))
        ...
        _emulateDragOver: function () {
            if (ut) {
                ...
                for (
                    ...
                    t && t.shadowRoot && (t = t.shadowRoot.elementFromPoint(ut.clientX, ut.clientY)) !== e;
                ...
                if ((V.parentNode[K]._isOutsideThisEl(t), e))
                    do {
                        if (e[K])
                            if (
                                e[K]._onDragOver({ clientX: ut.clientX, clientY: ut.clientY, target: t, rootEl: e }) &&
            ...
            if (!$) {
                ...
                if (Mt) {
                    ...
                    yt !== document.body && yt !== document.documentElement
                        ? (yt === document && (yt = O()), (e.top += yt.scrollTop), (e.left += yt.scrollLeft))
                        : (yt = O()),
                        (Ct = E(yt));
                }
                ...
                Ft.eventCanceled
                    ...
                    : (G('setupClone', this),
                      ...
                      (n.cloneId = Kt(function () {
                          G('clone', n),
                              Ft.eventCanceled ||
                                  (n.options.removeCloneOnHide || Q.insertBefore(et, V), n._hideClone(), q({ sortable: n, name: 'clone' }));
                      })),
                      e || k(V, i.dragClass, !0),
                      e
                          ...
                          : (f(document, 'mouseup', n._onDrop),
                            ...
                            o && ((o.effectAllowed = 'move'), i.setData && i.setData.call(n, o, V)),
                            h(document, 'drop', n),
        ...
        _onDragOver: function (n) {
            ...
            if (!Tt) {
                ...
                if (
                    ...
                    u &&
                        ...
                        (d
                            ? h || (i = Z !== Q)
                            : st === this || ((this.lastPutMode = lt.checkPull(this, u, V, n)) && c.checkPut(this, u, V, n))))
                ) {
                    ...
                    if (
                        ...
                        (D = L(D.el, D.options, $)),
                        !(c
                            ? S.clientX > D.right + 10 || (S.clientY > x.bottom && S.clientX > x.left)
                            : S.clientY > D.bottom + 10 || (S.clientX > x.right && S.clientY > x.top)) || m.animated)
                    ) {
                        if (
                            m &&
                            ((t = n),
                            ...
                            if (!1 !== S)
                                return (
                                    ...
                                    setTimeout(Lt, 30),
                                    M(),
                                    D && !x ? a.appendChild(V) : l.parentNode.insertBefore(V, D ? x : l),
                        ...
                        if (m === V) return A(!1);
                        if (((l = m && a === n.target ? m : l) && (E = X(l)), !1 !== jt(Q, a, V, o, l, E, n, !!l)))
                            return M(), m && m.nextSibling ? a.insertBefore(V, m.nextSibling) : a.appendChild(V), (Z = a), N(), A(!0);
                    }
            ...
            function N() {
                (it = j(V)),
                    (at = j(V, s.draggable)),
                    q({ sortable: p, name: 'change', toEl: a, newIndex: it, newDraggableIndex: at, originalEvent: n });
            }
        },
                ...
                Ft.eventCanceled ||
                    ...
                    t &&
                        ...
                        V &&
                            ...
                            Q !== Z
                                ? (0 <= it &&
                                      (q({ rootEl: Z, name: 'add', toEl: Z, fromEl: Q, originalEvent: t }),
                                      q({ sortable: this, name: 'remove', toEl: Z, originalEvent: t }),
                                      q({ rootEl: Z, name: 'sort', toEl: Z, fromEl: Q, originalEvent: t }),
                                      q({ sortable: this, name: 'sort', toEl: Z, originalEvent: t })),
                                  st && st.save())
                                : it !== ot &&
                                  0 <= it &&
                                  (q({ sortable: this, name: 'update', toEl: Z, originalEvent: t }),
                                  q({ sortable: this, name: 'sort', toEl: Z, originalEvent: t })),
                            Ft.active &&
                        ...
                        (0 == T && 0 == p) ||
                            ...
                            ($t[d].pid = setInterval(
                                function () {
                                    ...
                                    ('function' == typeof i &&
                                        'continue' !== i.call(Ft.dragged.parentNode[K], e, t, n, Vt, $t[this.layer].el)) ||
                        ...
                        dragOverAnimationCapture: function (t) {
                            ...
                            ue.forEach(function (t) {
                                ...
                                t.options.animation &&
                                    ...
                                    ((se = a({}, e)), (e = v(le, !0)), (se.top -= e.f), (se.left -= e.e));
                        },
                                ...
                                if (!pe)
                                    if (
                                        ...
                                        ue.splice(ue.indexOf(le), 1),
                                            (re = null),
                                            z({ sortable: i, rootEl: n, name: 'deselect', targetEl: le, originalEvent: e });
                                    else {
                                        if (
                                            (ue.push(le),
                                            z({ sortable: i, rootEl: n, name: 'select', targetEl: le, originalEvent: e }),
                                            ...
                                            if (~p && ~t && p !== t)
                                                for (var g, m = p < t ? ((g = p), t) : ((g = t), p + 1); g < m; g++)
                                                    ~ue.indexOf(f[g]) ||
                                                        ...
                                                        ue.push(f[g]),
                                                        z({ sortable: i, rootEl: n, name: 'select', targetEl: f[g], originalEvent: e }));
                                        } else re = le;
                                        ae = s;
                                    }
                                pe &&
                        ...
                        utils: {
                            select: function (t) {
                                ...
                                e &&
                                    e.options.multiDrag &&
                                    !~ue.indexOf(t) &&
                                    (ae && ae !== e && (ae.multiDrag._deselectMultiDrag(), (ae = e)),
                            ...
                            return (
                                ue.forEach(function (t) {
                                    ...
                                    o.push({ multiDragElement: t, index: t.sortableIndex }),
                                        (e = fe && t !== le ? -1 : fe ? j(t, ':not(.' + n.options.selectedClass + ')') : j(t)),
